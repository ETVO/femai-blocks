...
// Core constants 
define("PLUGIN_DIR", plugin_dir_path(__DIR__) . "femai-blocks/");
define("PLUGIN_URL", plugins_url("femai-blocks/"));
define("PLUGIN_CLASS", "FEMAI_Blocks");

/**
 * FEMAI Blocks plugin
 */
final class FEMAI_Blocks {
